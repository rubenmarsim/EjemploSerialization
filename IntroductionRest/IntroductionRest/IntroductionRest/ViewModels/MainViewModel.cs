...
namespace IntroductionRest.ViewModels
{
    public class MainViewModel : ViewModelBase
    {
        ...
        private ICommand _serializationCommand;
        ...
        {
            get { return _serializationCommand = _serializationCommand ?? new DelegateCommand(SerializationCommandExecute); }
        }
        ...
        private void SerializationCommandExecute()
        {
            _navigationService.NavigateTo<SerializationViewModel>();
        }
    }
}